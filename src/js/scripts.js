...
var actual_reverse = "src/img/dorsos/dorso_azul.jpg";
...
function choose_difficulty(difficulty_selected) {
    ...
    if (position_difficulty > 4) {
        dom_difficulty(position_difficulty);
    }
...
function lose_game() {
    ...
    if (!play1 && !play2 && !play3) {
        ...
        document.getElementsByClassName("container_results")[0].classList.add("end_game");
        document.getElementsByClassName("background_results")[0].classList.add("end_game");
        document.getElementsByClassName("icon_result")[0].setAttribute("src", "src/img/defeat.png");
        get_timer("lose");
    }
}
        ...
        case "Azul":
            for (num_cart = 0; num_cart < all_carts.length; num_cart++) {
                if (all_carts[num_cart].getAttribute("src").includes("dorsos")) {
                    all_carts[num_cart].setAttribute("src", "src/img/dorsos/dorso_azul.jpg");
                }
            }
            actual_reverse = "src/img/dorsos/dorso_azul.jpg";
            break;
        case "Oscuro":
            for (num_cart = 0; num_cart < all_carts.length; num_cart++) {
                if (all_carts[num_cart].getAttribute("src").includes("dorsos")) {
                    all_carts[num_cart].setAttribute("src", "src/img/dorsos/dorso_oscuro.jpg");
                }
            }
            actual_reverse = "src/img/dorsos/dorso_oscuro.jpg";
            break;
        case "Hearthstone":
            for (num_cart = 0; num_cart < all_carts.length; num_cart++) {
                if (all_carts[num_cart].getAttribute("src").includes("dorsos")) {
                    all_carts[num_cart].setAttribute("src", "src/img/dorsos/dorso_hs.png");
                }
            }
